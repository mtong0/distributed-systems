package com.example.RESTServicePrj;// This is a JAX-RS service that allows visitors to store, retrieve, and delete
// name value pairs.
...
public class VariableMemory {
    ...
    public Response getVariableList() {
        return Response.status(200).entity(memory.keySet().toString()).build();
    }
